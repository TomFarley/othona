...
#.
    #.  **New GitHub repository**.
        ...
        You can create a new repository on GitHub from this template by clicking the `Use this template <https://github.com/TomFarley/othona/generate>`_ button.
...
#.  Swap out the contents of ``README.rst`` with an inital description of your project.
    If you are keeping all the badges, make sure to change the URLs from ``TomFarley/othona`` to ``your_username/your_repo``.
